...
const AdminRiderDetailModal = ({ isOpen, onClose, riderId }) => {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
      <div className="bg-(--color-base-100) rounded-2xl max-w-xl w-full p-6 space-y-4">
        <h3 className="text-lg font-bold text-(--color-base-content)">
          Rider Details & KYC Documents
        </h3>
        {/* Placeholder for rider vehicle, KYC files, and status verification (consumes GET /admin/riders/:riderId) */}
